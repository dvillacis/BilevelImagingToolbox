...
(fb_image,fb_values) = solvers.forward_backward_ROF(g_image,clambda,tau,iters=200)
# Call the solver using Chambolle-Pock
(cp_image,cp_values) = solvers.chambolle_pock_ROF(g_image,clambda,tau,sigma,iters=200)
