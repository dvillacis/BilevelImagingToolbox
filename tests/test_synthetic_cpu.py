...
for image_path in s_image_list:
    ...
    print('Execution time for FB for ROF on '+image_path+': %d,%d'%(np.mean(times),np.std(times)))
...
for image_path in s_image_list:
    ...
    print('Execution time for CP for ROF on '+image_path+': %d,%d'%(np.mean(times),np.std(times)))
